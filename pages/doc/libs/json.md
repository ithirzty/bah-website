...
- <code>**map**(key cpstring) jsonElement* </code> If the current element is of type map, this method is used to get a children element mapped to this key.
- <code>**str**() cpstring </code> To get the current element as a cpstring no matter its type.


### parseJson (func)
<code>parseJson(a cpstring) jsonElement* </code>
